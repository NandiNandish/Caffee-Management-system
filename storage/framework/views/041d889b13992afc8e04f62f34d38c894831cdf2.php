					...
					<table class="table table-hover overflow-auto block">
						<thead>
							<tr class="bg-slate-800">
								<?php $__currentLoopData = ["Name", "Phone number", "Date", "Time", "Person", "Table No","Created at"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $heading): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<tbody>
							...
							<?php else: ?>
								...
								<tr>
									...
									<td><?php echo e($data->table_no); ?></td>
...
<?php endif; ?>
<?php /**PATH E:\Diploma Clge\6th sem\restaurant-site-laravel\resources\views/admin/pages/reservation.blade.php ENDPATH**/ ?>