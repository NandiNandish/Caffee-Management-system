    ...
    <form action="<?php echo e(route('reservation.store')); ?>"  method="post" enctype="multipart/form-data" class="bg-slate-800/75 border-2 inline-block mx-5 md:mx-0 px-1.5 md:px-6 py-4 pb-5 md:py-8 md:pb-8 shadow-md">
      ...
      <div class="flex flex-wrap items-center justify-center">
        ...
        <div class="m-3 relative">
          ...
          <input type="text" name="time" id="timepicker" class="w-48 md:w-24 rounded pl-8 text-[14px] font-sans-lato text-slate-700 leading-relaxed" placeholder="Time">
        </div>
        <div class="m-3 relative">
      ...
      <div class="text-center">
        <span class="absolute top-0 left-0 px-2.5 py-2 text-slate-700"><i class="fa-solid fa-clock text-[14px]"></i></span>
          <input type="number" name="table_no" id="timepicker" class="w-48 md:w-24 rounded pl-8 text-[14px] font-sans-lato text-slate-700 leading-relaxed" placeholder="Table No">
  ...
  <!-- Table Area End --><?php /**PATH E:\Diploma Clge\6th sem\restaurant-site-laravel\resources\views/home/partials/table.blade.php ENDPATH**/ ?>