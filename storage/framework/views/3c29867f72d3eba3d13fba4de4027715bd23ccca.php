    ...
    <section id="about" class="flex flex-wrap item-center justify-center lg-p-0 lg:justify-between lg:p-0 lg:pt-28 max-w-[960px] mx-auto p-5">
      ...
      <div class="basis-[400px] grow max-w-[650px] p-5">
        <h3 class="font-bold font-cursive-merie text-4xl">
          <span class="text-amber-400 leading-snug">welcome</span> <br /><span class=" leading-normal">to Guddu's Cafe</span>
        </h3>
    ...
    <!-- Welcome Area End -->
<?php /**PATH E:\Diploma Clge\6th sem\restaurant-site-laravel\resources\views/home/partials/welcome.blade.php ENDPATH**/ ?>